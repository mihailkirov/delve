...
const DelveMainPackagePath = "github.com/mihailkirov/delve/cmd/dlv"
...
`,
	...
	integration 	tests github.com/mihailkirov/delve/service/test
...
func testSetToPackages(testSet string) []string {
	...
	case "basic":
		return []string{"github.com/mihailkirov/delve/pkg/proc", "github.com/mihailkirov/delve/service/test", "github.com/mihailkirov/delve/pkg/terminal"}

	case "integration":
		return []string{"github.com/mihailkirov/delve/service/test"}
