...
import (
	...
	"github.com/mkirov/delve/pkg/terminal"
	"github.com/mkirov/delve/service/dap"
	"github.com/mkirov/delve/service/dap/daptest"
	"github.com/mkirov/delve/service/rpc2"
...
func getDlvBinInternal(t *testing.T, goflags ...string) string {
	...
	args = append(args, "github.com/mkirov/delve/cmd/dlv")

	out, err := exec.Command("go", args...).CombinedOutput()
	if err != nil {
		t.Fatalf("go build -o %v github.com/mkirov/delve/cmd/dlv: %v\n%s", dlvbin, err, string(out))
	}
...
func TestTypecheckRPC(t *testing.T) {
	...
	pkgs, err := packages.Load(cfg, "github.com/mkirov/delve/service/rpc2")
	if err != nil {
		t.Fatal(err)
	}
	...
	packages.Visit(pkgs, func(pkg *packages.Package) bool {
		if pkg.PkgPath != "github.com/mkirov/delve/service/rpc2" {
			return true
		}
...
func TestVersion(t *testing.T) {
	...
	want1 := []byte("mod\tgithub.com/mkirov/delve")
...
func TestStaticcheck(t *testing.T) {
	...
	args := []string{"-tests=false", "-checks=all,-SA1019,-ST1000,-ST1003,-ST1016,-S1021,-ST1023", "github.com/mkirov/delve/..."}
