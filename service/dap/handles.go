...
import "github.com/mihailkirov/delve/pkg/proc"
...
type fullyQualifiedVariable struct {
	*proc.Variable
	...
	// https://github.com/mihailkirov/delve/blob/master/Documentation/api/ClientHowto.md#loading-more-of-a-variable
