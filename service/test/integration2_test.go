...
import (
	...
	"github.com/mihailkirov/delve/service/rpccommon"
)
...
func TestClientServer_FindLocations(t *testing.T) {
	...
	if goversion.VersionAfterOrEqual(runtime.Version(), 1, 13) {
		withTestClient2("pkgrenames", t, func(c service.Client) {
			someFuncLoc := findLocationHelper(t, c, "github.com/mihailkirov/delve/_fixtures/internal/dir%2eio.SomeFunction:0", false, 1, 0)[0]
...
func TestDetachLeaveRunning(t *testing.T) {
	// See https://github.com/mihailkirov/delve/issues/2259
	if testBackend == "rr" {
		return
	}
...
func TestPluginSuspendedBreakpoint(t *testing.T) {
	...
	withTestClient2Extended("plugintest", t, protest.AllNonOptimized, [3]string{}, []string{pluginFixtures[0].Path, pluginFixtures[1].Path}, func(c service.Client, f protest.Fixture) {
		_, err := c.CreateBreakpointWithExpr(&api.Breakpoint{FunctionName: "github.com/mihailkirov/delve/_fixtures/plugin1.Fn1", Line: 1}, "", nil, true)
