...
func TestFunctionLocationParsing(t *testing.T) {
	...
	assertNormalLocationSpec(t, "github.com/mkirov/delve/pkg/proc.(*Process).Continue", NormalLocationSpec{"github.com/mkirov/delve/pkg/proc.(*Process).Continue", &FuncLocationSpec{PackageName: "github.com/mkirov/delve/pkg/proc", ReceiverName: "Process", BaseName: "Continue"}, -1})
	assertNormalLocationSpec(t, "github.com/mkirov/delve/pkg/proc.Process.Continue", NormalLocationSpec{"github.com/mkirov/delve/pkg/proc.Process.Continue", &FuncLocationSpec{PackageName: "github.com/mkirov/delve/pkg/proc", ReceiverName: "Process", BaseName: "Continue"}, -1})
	assertNormalLocationSpec(t, "github.com/mkirov/delve/pkg/proc.Continue", NormalLocationSpec{"github.com/mkirov/delve/pkg/proc.Continue", &FuncLocationSpec{PackageName: "github.com/mkirov/delve/pkg/proc", BaseName: "Continue"}, -1})

	// Function locations, package paths, line offsets
	assertNormalLocationSpec(t, "github.com/mkirov/delve/pkg/proc.(*Process).Continue:10", NormalLocationSpec{"github.com/mkirov/delve/pkg/proc.(*Process).Continue", &FuncLocationSpec{PackageName: "github.com/mkirov/delve/pkg/proc", ReceiverName: "Process", BaseName: "Continue"}, 10})
	assertNormalLocationSpec(t, "github.com/mkirov/delve/pkg/proc.Process.Continue:10", NormalLocationSpec{"github.com/mkirov/delve/pkg/proc.Process.Continue", &FuncLocationSpec{PackageName: "github.com/mkirov/delve/pkg/proc", ReceiverName: "Process", BaseName: "Continue"}, 10})
	assertNormalLocationSpec(t, "github.com/mkirov/delve/pkg/proc.Continue:10", NormalLocationSpec{"github.com/mkirov/delve/pkg/proc.Continue", &FuncLocationSpec{PackageName: "github.com/mkirov/delve/pkg/proc", BaseName: "Continue"}, 10})
}
