...
import (
	...
	"github.com/mihailkirov/delve/pkg/proc/core"
...
func TestCGONext(t *testing.T) {
	...
	skipOn(t, "broken - see https://github.com/mihailkirov/delve/issues/3158", "darwin", "amd64")
...
func TestIssue414(t *testing.T) {
	...
	withTestProcess("math", t, func(p *proc.Target, grp *proc.TargetGroup, fixture protest.Fixture) {
		...
		for {
			...
			// See: https://github.com/mihailkirov/delve/pull/2082
			if f == fixture.Source {
				err = grp.Step()
			} else {
				err = grp.Next()
...
func TestVariablesWithExternalLinking(t *testing.T) {
	...
	//  https://github.com/mihailkirov/delve/issues/2346
...
func TestWatchpointsBasic(t *testing.T) {
	...
	skipOn(t, "not implemented", "ppc64le")
	skipOn(t, "see https://github.com/mihailkirov/delve/issues/2768", "windows")
	protest.AllowRecording(t)
