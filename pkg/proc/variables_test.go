...
func TestPackageRenames(t *testing.T) {
	...
	testcases := []varTest{
		...
		{"iface3", true, `interface {}(*github.com/mkirov/delve/_fixtures/internal/dir0/renamedpackage.SomeType) *{A: true}`, "", "interface {}", nil},

		// Interfaces to anonymous types
		{"dir0someType", true, "interface {}(*github.com/mkirov/delve/_fixtures/internal/dir0/pkg.SomeType) *{X: 3}", "", "interface {}", nil},
		{"dir1someType", true, "interface {}(github.com/mkirov/delve/_fixtures/internal/dir1/pkg.SomeType) {X: 1, Y: 2}", "", "interface {}", nil},
		{"amap3", true, "interface {}(map[github.com/mkirov/delve/_fixtures/internal/dir0/pkg.SomeType]github.com/mkirov/delve/_fixtures/internal/dir1/pkg.SomeType) [{X: 4}: {X: 5, Y: 6}, ]", "", "interface {}", nil},
		{"anarray", true, `interface {}([2]github.com/mkirov/delve/_fixtures/internal/dir0/pkg.SomeType) [{X: 1},{X: 2}]`, "", "interface {}", nil},
		{"achan", true, `interface {}(chan github.com/mkirov/delve/_fixtures/internal/dir0/pkg.SomeType) chan github.com/mkirov/delve/_fixtures/internal/dir0/pkg.SomeType 0/0`, "", "interface {}", nil},
		{"aslice", true, `interface {}([]github.com/mkirov/delve/_fixtures/internal/dir0/pkg.SomeType) [{X: 3},{X: 4}]`, "", "interface {}", nil},
		{"afunc", true, `interface {}(func(github.com/mkirov/delve/_fixtures/internal/dir0/pkg.SomeType, github.com/mkirov/delve/_fixtures/internal/dir1/pkg.SomeType)) main.main.func1`, "", "interface {}", nil},
		{"astruct", true, `interface {}(*struct { A github.com/mkirov/delve/_fixtures/internal/dir1/pkg.SomeType; B github.com/mkirov/delve/_fixtures/internal/dir0/pkg.SomeType }) *{A: github.com/mkirov/delve/_fixtures/internal/dir1/pkg.SomeType {X: 1, Y: 2}, B: github.com/mkirov/delve/_fixtures/internal/dir0/pkg.SomeType {X: 3}}`, "", "interface {}", nil},
		{"iface2iface", true, `interface {}(*interface { AMethod(int) int; AnotherMethod(int) int }) **github.com/mkirov/delve/_fixtures/internal/dir0/pkg.SomeType {X: 4}`, "", "interface {}", nil},
	...
	testcases1_9 := []varTest{
		{"astruct2", true, `interface {}(*struct { github.com/mkirov/delve/_fixtures/internal/dir1/pkg.SomeType; X int }) *{SomeType: github.com/mkirov/delve/_fixtures/internal/dir1/pkg.SomeType {X: 1, Y: 2}, X: 10}`, "", "interface {}", nil},
	}
...
func TestPluginVariables(t *testing.T) {
	...
	withTestProcessArgs("plugintest2", t, ".", []string{pluginFixtures[0].Path, pluginFixtures[1].Path}, protest.AllNonOptimized, func(p *proc.Target, grp *proc.TargetGroup, fixture protest.Fixture) {
		...
		bp := setFunctionBreakpoint(p, t, "github.com/mkirov/delve/_fixtures/plugin2.TypesTest")
		t.Logf("bp.Addr = %#x", bp.Addr)
		setFunctionBreakpoint(p, t, "github.com/mkirov/delve/_fixtures/plugin2.aIsNotNil")
		...
		for _, v := range allvars {
			switch v.Name {
			case "github.com/mkirov/delve/_fixtures/plugin2.A":
				plugin2AFound = true
			case "main.ExeGlobal":
		...
		assertVariable(t, vs, varTest{"s", true, `github.com/mkirov/delve/_fixtures/internal/pluginsupport.Something(*main.asomething) *{n: 2}`, ``, `github.com/mkirov/delve/_fixtures/internal/pluginsupport.Something`, nil})
		...
		assertCurrentLocationFunction(p, t, "github.com/mkirov/delve/_fixtures/plugin2.aIsNotNil")
		...
		assertVariable(t, vb, varTest{"b", true, `github.com/mkirov/delve/_fixtures/internal/pluginsupport.SomethingElse(*github.com/mkirov/delve/_fixtures/plugin2.asomethingelse) *{x: 1, y: 4}`, ``, `github.com/mkirov/delve/_fixtures/internal/pluginsupport.SomethingElse`, nil})
	})
}
